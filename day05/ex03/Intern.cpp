...
/*   Updated: 2023/01/23 10:18:44 by mel-kora         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Intern::Intern()
{
    std::cout << SIMPLE_Bright_Green << "Intern added" << Color_CLEAR << std::endl;
}
...
Intern::~Intern()
{
    std::cout << SIMPLE_Matte_Green << "Intern removed"<< Color_CLEAR << std::endl;
}
...
Form *Intern::makeForm(std::string name, std:: string target)
{
	...
	std::cout << BOLD_Bright_Red << "Form " << name << " cannot be created so do NOT use it\n" << Color_CLEAR;
	return (NULL);
}
